(function () {
  ...
  window.GTOApp.config = {
    ...
    steps: [
      ...
      { id: 'standards', title: 'Нормативы ГТО', description: 'Выберите перечень испытаний для каждого участника по его ступени.' },
      { id: 'review', title: 'Проверка и выгрузка', description: 'Проверьте проблемные поля и скачайте итоговый Excel и карточки.' }
    ],
    ...
    schoolHeaderSynonyms: {
      ...
      uin: ['уин', 'win', 'uin', 'уин участника', 'уин (подтвержденный на госуслугах)']
    },
    asuFields: {
      className: ['класс'],
      surname: ['фамилия'],
